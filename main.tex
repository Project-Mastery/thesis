...
\begin{figure}[h]
  ...
  \caption{Example of how \gls{ecsmos} handles inter-module dependencies where there is no pre-defined system set grouping only the required systems. The thick dashed and rounded square represents the unnamed set created.}
